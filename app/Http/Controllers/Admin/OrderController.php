...
class OrderController extends Controller
{
    ...
    public function show(int $orderId)
    {
        ...
        if ($order) {
            ...
            return redirect('admin/orders')->with('message','Orderan Id tidak ditemukan');
        }
    ...
    public function updateOrderStatus(int $orderId, Request $request)
    {
        ...
        if ($order) {
            ...
            return redirect('admin/orders/'.$orderId)->with('message','Orderan Id tidak ditemukan');
        }
    }
    ...
    public function mailInvoice(int $orderId)
    {
        ...
        try{
            ...
            return redirect('admin/orders/'.$orderId)->with('message','Ada Kesalahan');
        }
