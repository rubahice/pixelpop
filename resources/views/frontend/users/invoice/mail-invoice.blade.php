...
<body>
        ...
        <thead>
            <tr>
                <th width="50%" colspan="2">
                    <h2 class="text-start">{{ $appSetting->website_name ?? "PIXELPOP" }}</h2>
                </th>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td width="15%" class="fw-bold">Rp.{{ number_format($orderItem->quantity * $orderItem->price) }}</td>
                @php
            ...
            @endforeach
            <tr>
                <td colspan="4" class="total-heading">Total Amount
                    {{-- - <small>Inc. all vat/tax</small> --}}
                    :</td>
                <td colspan="1" class="total-heading">Rp.{{ number_format($totalPrice) }}</td>
            </tr>
    ...
    <br>
    <p class="text-center">
        Thank your for shopping with {{ $appSetting->website_name ?? "PIXELPOP" }}
    </p>
